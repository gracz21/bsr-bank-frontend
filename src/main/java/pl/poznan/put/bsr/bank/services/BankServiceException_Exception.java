 ...
 */
@WebFault(name = "BankServiceException", targetNamespace = "http://services.bank.bsr.put.poznan.pl/")
public class BankServiceException_Exception
    ...
    /**
     * @return returns fault bean: pl.poznan.put.bsr.bank.services.BankServiceException
     */
