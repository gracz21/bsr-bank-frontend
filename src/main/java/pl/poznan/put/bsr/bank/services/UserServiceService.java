 ...
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://services.bank.bsr.put.poznan.pl/", wsdlLocation = "http://localhost:8000/users?WSDL")
public class UserServiceService
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://services.bank.bsr.put.poznan.pl/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/users?WSDL");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://services.bank.bsr.put.poznan.pl/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.bank.bsr.put.poznan.pl/", "UserServicePort"), UserService.class, features);
    }
